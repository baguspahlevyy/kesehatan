                    ...
                    @if( $aktiv  ==  $id_main )
                        ...
                        <li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
                            ...
                            <a href="{{ url($r["link"]) }}" class="nav-link active">
                                ...
                                <i class="icon-{{ $r["icon"] }} text-info"></i> <span> {{ strtoupper($r["name_menu"]) }}</span>
                    ...
                    @else
                        ...
                        <li class="nav-item nav-item-submenu">
                            ...
                            <a href="{{ url($r["link"]) }}" class="nav-link">
                                ...
                                <i class="icon-{{  $r["icon"] }} text-success"></i> <span> {{ strtoupper($r["name_menu"]) }}</span>
                ...
                @else
                    ...
                    <li class="nav-item">
                        ...
                        <a href="{{ url($r["link"]) }}" class="nav-link legitRipple">
                            ...
                            <i class="icon-{{  $r["icon"] }} text-success"></i>
           ...
           foreach($listsub[$id_main] as $x ){
               ...
               foreach($x as $r2){
                   ...
                   @endphp
                        ...
                        <li class="nav-item " ><a href="{{ url($r2["link"]) }}" class="nav-link text-primary font-weight-bold"><span class="badge badge-mark border-success mr-2"></span>{{ $r2["name_menu"] }}</a></li>

                     @php
                        }
                        else{
                     @endphp
                        <li class="nav-item "><a href="{{ url($r2["link"]) }}" class="nav-link"><span class="badge badge-mark border-success mr-2"></span>{{ $r2["name_menu"] }}</a></li>
                @php
                        }
